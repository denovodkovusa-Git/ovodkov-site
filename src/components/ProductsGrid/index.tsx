        ...
        <section className="bg-black py-48">
            <div className="container mx-auto px-6">
                <header className="flex flex-col mb-32 max-w-4xl">
                    ...
                    <h2 className="text-[12px] font-bold tracking-[0.6em] uppercase text-accent-vivid/60 mb-8 bork-text-glow">
                        Collection — 2026
                    </h2>
                    ...
                    <p className="text-lg text-white/30 font-light leading-relaxed tracking-wider max-w-2xl">
                        Безупречное сочетание индустриальной эстетики и профессиональной функциональности. <span className="text-white/60">Создано для тех, кто не приемлет компромиссов.</span>
                    </p>
                </header>
