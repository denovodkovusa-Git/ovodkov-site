            ...
            <div className="container mx-auto px-6 py-24">
                <header className="max-w-4xl mb-32">
                    ...
                    <h1 className="text-6xl md:text-8xl font-black uppercase tracking-tighter leading-none mb-12">
                        Ovodkov <br /><span className="text-accent-vivid italic font-thin opacity-80 brand-text-glow">Collection</span>
                    </h1>
                    <p className="text-xl text-white/40 font-light leading-relaxed max-w-2xl uppercase tracking-widest">
                        Кураторская подборка модульных решений для вашего дома и загородного пространства.
                        ...
                        <section key={i} className="group relative">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                                <div className={i % 2 === 1 ? 'lg:order-2' : ''}>
                                    <div className="mb-12">
                                        <div className={`w-12 h-1 ${item.accent} mb-8 brand-glow`} />
                                ...
                                <div className="relative aspect-video lg:aspect-square bg-white/[0.02] border border-white/5 overflow-hidden">
                                    ...
                                    <div className="absolute inset-0 flex items-center justify-center">
                                        <span className="text-[10vw] font-black text-white/5 uppercase select-none tracking-tighter text-center leading-none">
                                            OVODKOV<br />& CO
                                        </span>
                                    </div>
                                </div>
